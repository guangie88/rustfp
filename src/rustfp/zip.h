...
namespace rustfp
{
    namespace details
    {
        ...
        public:
            ...
            auto next() -> Option<Item>
            {
                ...
                {
                    return Some(Item(opt_next.unwrap_unchecked(), opt_rhs_next.unwrap_unchecked()));
                }
        ...
        public:
            ...
            {
                static_assert(!std::is_lvalue_reference<Iterator>::value, "zip can only take rvalue ref object with Iterator traits");
    ...
    {
        static_assert(!std::is_lvalue_reference<IteratorRhs>::value, "zip can only take second rvalue ref object with Iterator traits");
